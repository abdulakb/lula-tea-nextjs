  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 md:bottom-6 left-6 z-50 w-14 h-14 bg-tea-green hover:bg-tea-green/90 text-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center group"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-44 md:bottom-24 left-6 z-50 w-[90vw] md:w-96 bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[600px]">
          {/* Header */}
