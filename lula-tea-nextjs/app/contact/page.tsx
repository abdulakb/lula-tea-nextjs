...
export const metadata: Metadata = {
  title: "Contact Us - Lula Tea",
  description: "Get in touch with Lula Tea. Order via WhatsApp or send us a message.",
};
    ...
    <main className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-deep-brown mb-4">
            Get in Touch
          </h1>
          <p className="text-xl text-tea-brown max-w-2xl mx-auto">
            We'd love to hear from you! Order online or reach out via WhatsApp 
            for personalized service and inquiries.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-tea-green/10 to-soft-sage/10 rounded-3xl p-8 md:p-12">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-deep-brown mb-1">Quick Response</h3>
                    <p className="text-tea-brown">We respond to all inquiries within 24 hours</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-tea-green flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <h3 className="font-semibold text-deep-brown mb-1">Personalized Service</h3>
                    <p className="text-tea-brown">Get recommendations tailored to your taste</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-tea-green flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <h3 className="font-semibold text-deep-brown mb-1">Easy Ordering</h3>
                    <p className="text-tea-brown">Order directly through WhatsApp or our website</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-tea-green flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <h3 className="font-semibold text-deep-brown mb-1">Quality Guarantee</h3>
                    <p className="text-tea-brown">We stand behind every product we sell</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
              ...
              <p className="text-tea-brown mb-6">
                Have questions about our tea blends? Want to place a custom order? 
                Or just want to chat about tea? We're here to help!
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-deep-brown">Response Time</p>
                    <p className="text-tea-brown">Usually within a few hours</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-deep-brown">Preferred Contact</p>
                    <p className="text-tea-brown">WhatsApp for fastest response</p>
                  </div>
                </div>
              </div>
            </div>
