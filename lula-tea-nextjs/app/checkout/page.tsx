        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-warm-cream rounded-3xl shadow-xl p-8">
            ...
            <button
              ...
              className="w-full bg-[#25D366] hover:bg-[#22c55e] text-white px-6 py-4 rounded-full font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 mb-4"
            >
            ...
            <button
              disabled
              className="w-full bg-tea-brown/50 text-white px-6 py-4 rounded-full font-semibold cursor-not-allowed"
            >
              {t("placeOrder")} ({language === "ar" ? "قريباً" : "Coming Soon"})
            </button>
          </div>
        </div>
      </div>
